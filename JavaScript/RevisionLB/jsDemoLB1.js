...
// JS runs on browser by using JS Engine ,For Chrome it uses V8 engine ad Firefox uses SpiderMonkey engingn
// To view the results into terminal , we need to run 'node fileName.js' into terminal (JAVASRIPT FILE)
// Console.log("Hii") means that print (.log) "Hii"(message) on the page(console).


console.log("Hello Mayank , How are you !!!");